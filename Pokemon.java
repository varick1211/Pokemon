public class Pokemon {
    ...
    public Pokemon(String name, String type, int level) {
        ...
        this.type = type;
        this.level = level;
        this.shiny = Math.random() < 0.10; // 10% chance for shiny
        this.fainted = false;
        this.status = "normal";
    ...
    public int performAttack(Pokemon target) {
        ...
        damage += (int) (Math.random() * 10) - 5; // Random variance of -5 to +4
    ...
    public boolean canBeCaught() {
        // Higher catch rate when Pokemon has lower HP
    ...
    public String getDetailedInfo() {
        return String.format("""
            ...
            ==========================
            """,
            name, type, level, shiny ? "SHINY" : "Normal",
